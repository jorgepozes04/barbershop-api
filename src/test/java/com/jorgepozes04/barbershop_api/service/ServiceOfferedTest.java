...
public class ServiceOfferedTest {
    ...
    void testRegisterService() {
        ServiceOfferedDTO inputDTO = new ServiceOfferedDTO(1l, "Haircut", BigDecimal.valueOf(20), 30, "A stylish haircut");

        ServiceOffered savedService = new ServiceOffered(1L, "Haircut", BigDecimal.valueOf(20), 30, "A stylish haircut");
